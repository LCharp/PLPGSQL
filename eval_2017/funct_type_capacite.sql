DROP FUNCTION IF EXISTS funct_verif_type_capacite() CASCADE;

CREATE FUNCTION funct_verif_type_capacite returns TRIGGER AS $$
DECLARE
    num_pkm string;
    nb_ct integer;
    curs refcursor;
...
CREATE TRIGGER trigger_verif_type_capacite after INSERT ON pkm_connaitre
    FOR EACH ROW
